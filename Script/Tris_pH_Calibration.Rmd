...
pHcalib<-read_csv("Data/Mesocosm_Data/Mesocosm_pH/TrispHcalibration.csv")
pHData<-read_csv("Data/Mesocosm_Data/Mesocosm_pH/pH_mesocosm.csv")
...
## write the data
write_csv(pHSlope, paste0('Data/Mesocosm_Data/Mesocosm_pH/pHTotal.csv'))
