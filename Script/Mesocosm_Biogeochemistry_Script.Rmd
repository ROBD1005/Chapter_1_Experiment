...
gt_summary_table <- gt(summary_table) %>%
  tab_header(
    title = "Summary of Treatment Conditions",
    subtitle = "Mean values with standard deviations for each temperature and pH treatment"
  ) %>%
  cols_label(
  ...
  tab_spanner(label = "Summary of Treatment Conditions", columns = everything())
