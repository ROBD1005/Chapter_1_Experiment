...
# Calculates parameters from Q10 temperature coefficient for respirometry data
...
low_Tref <- LT2 - (10 * log(LR2/LR1) / (log(low_pH_Q10) * log(e)))
ambient_Tref <- AT2 - (10 * log(AR2/AR1) / (log(ambient_pH_Q10) * log(e)))
...
model_selection_fits <- nest(respo.rates.tpc, data = c(temp, rate)) %>% 
   mutate(boatman = map(data, ~nls_multstart(rate~boatman_2017(temp = temp, rmax, tmin, tmax, a,b),
         ...
         quadratic = map(data, ~nls_multstart(rate~quadratic_2008(temp = temp, a, b, c),
                        ...
                        supp_errors = 'Y',
                        convergence_count = FALSE)),
         sharpeschoolhigh = map(data, ~nls_multstart(rate~sharpeschoolhigh_1981(temp = temp, r_tref,e,eh,th, tref = 12),
                        data = .x,
                        iter = c(4,4,4,4),
